...
//     key2 : "value2"
// }
//  console.log(obj1.key1); // cara mengakses object nama var.key
...
// //menghapus properti
// delete obj1.key2; // hanya untuk menghapus isi property/ value dari property tersebut
// console.table(obj1);
...
// console.log(obj2.motor.merkBan.ban1); // cara mengakses object
// obj2.motor.merkMotor.motor1 = 'yamaha' // contoh mengubah properti
// obj2.motor.knalpot = 'mbeerrr' // contoh menambahkan properti
// delete obj2.motor.merkBan.ban2; // menghapus
// obj2.motor.merkMotor.motor2 = 'honda'
// console.table(obj2);

// contoh log nested
for (let a in obj2) { // a(key dari obj2) 
    if (typeof obj2[a] === 'object') { // cek apakah obj2 itu === object
        for (let b in obj2[a]) {  // buat wadah b yaitu key nya untuk memasukkan obj yang sudah berada a 
            console.log(`ini merk yang saya suka = ${b}\n`); // panggil b nya yaitu untuk tampilkan key nya / property
            if (typeof obj2[a][b] === 'object') {  // jika a dan b itu object maka eksekusi
                for (let c in obj2[a][b]) {   // buat wadah c yaitu key nya untuk memasukkan obj yang sudah berada di b 
                    console.log(`ini dia ${c} ==> ${obj2[a][b][c]}\n`); // manggil c nya untuk tampilkan key sebut saja key level 3/property
                }
            } else {
...
let juzAndSurat = [];  // buat laci kosong


  let mapJuzDanSurat = objQuran.data.map(function(a,b,c){           
    //.map untuk me looping isi objQuran
    // a item misal (name : juz 1, name_start_id : al-fatihah)
    // b index nya urutan mulai dari 0
    // array nya
       juzAndSurat.push({
     // Masukkan object baru ke dalam array juzAndSurat
    // Object ini isinya cuma 2 properti
            juz: a.name,
            surat: a.name_start_id
        }) 
     // return juga object yang sama
    // karena .map() selalu menghasilkan array baru
    // jadi mapJuzDanSurat akan berisi array object seperti ini
     return {juz :  a.name , surat :a.name_start_id}

    })
    // tampilkan dengan bentuk table karena agar mudah  di liat
